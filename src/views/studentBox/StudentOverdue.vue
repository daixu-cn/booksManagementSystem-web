<template>
  <div class="container">
    ...
    <el-table :data="tableData" stripe border style="width: 100%">
      ...
      <el-table-column prop="returnDate" label="最迟还书" width="100"></el-table-column>
      <el-table-column prop="overtime" label="逾期天数" width="80"></el-table-column>
      <el-table-column prop="penalty" label="应缴罚款"></el-table-column>
    </el-table>
    <div class="stipulation">
      *根据我校规定,图书逾期未还将按每天0.5元收取罚款,上限为书的市场价格
    </div>
    <div class="block">
      <el-pagination
